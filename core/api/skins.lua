    ...
    -- }
    local BACKDROP = {
        bgFile = "Interface\\AddOns\\DarksidersUI\\art\\misc\\button_background",
        edgeFile = "Interface\\AddOns\\DarksidersUI\\art\\misc\\outer_shadow",
        tile = false,
        tileSize = 32,
        edgeSize = 10,
        insets = {
    ...
    local t = CreateFont'dksdHotKeyFont'
    ...
    ns.BD = function(bu, a, ix)               --  build in an anti-fuckup
        ...
        bu.BD:SetPoint("TOPLEFT", bu, 'TOPLEFT', -10, 10)
        bu.BD:SetPoint("BOTTOMRIGHT", bu, 'BOTTOMRIGHT', 10, -10)
    ...
    ns.BG = function (bu)
        ...
        t:SetTexture("Interface\\AddOns\\DarksidersUI\\art\\misc\\button_background")
    end
    ...
    ns.BUElements = function(bu)
        ...
        if  bu.HotKey then
            ...
            NumberFontNormalSmallGray:SetFontObject'dksdHotKeyFont'
        end
