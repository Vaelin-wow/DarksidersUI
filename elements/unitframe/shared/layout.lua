	...
	local colours = setmetatable({
		...
		reaction = setmetatable({
			...
			[3] = {1, 0, 0},
			[4] = {1, 1, 0},
			[5] = {19/255 , 220/255, 73/255},
			[6] = {19/255 , 220/255, 73/255},
			[7] = {19/255 , 220/255, 73/255},
			[8] = {19/255 , 220/255, 73/255},
	...
	local AddHealth = function(self)
		...
		Health.BD:SetVertexColor(.066, .066, .066)
	...
	local AddPower = function(self)
		...
		-- ns.BD(Power)
		-- ns.SB(Power)
		Power:SetStatusBarTexture[[Interface\AddOns\DarksidersUI\art\unitframe\Energy]]
		Power:SetFrameStrata'BACKGROUND'
		Power:SetHeight(14)
		Power:SetPoint'LEFT'
		Power:SetPoint'RIGHT'
		Power:SetPoint('TOP', self.Health, 'BOTTOM', 0, -5)
		...
		ns.SB(Power.BD)
		Power.BD:SetVertexColor(.066, .066, .066)
