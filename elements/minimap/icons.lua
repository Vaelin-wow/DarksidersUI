	...
	local _, ns = ...
	local path 	= 'Interface\\AddOns\\DarksidersUI\\art\\map\\'
	...
	local indicator = CreateFrame('Button', 'dksdMinimapIcon', Minimap)
	indicator:SetSize(32, 32)
	indicator:RegisterForClicks'AnyUp'
	indicator:SetPoint('BOTTOMRIGHT', Minimap, 8, -10)

	indicator.t = indicator:CreateTexture(nil, 'ARTWORK')
	indicator.t:ClearAllPoints()
	indicator.t:SetPoint('BOTTOMRIGHT', Minimap, 8, -10)
	indicator.t:SetSize(32, 32)
	indicator.t:SetTexture(path..'hall5')
	...
	local bugs = CreateFrame('Button', 'dksdFuck', Minimap)
	ns.BD(bugs)
	...
	e:RegisterEvent"GARRISON_MISSION_BONUS_ROLL_LOOT"
	e:RegisterEvent"GARRISON_MISSION_BONUS_ROLL_COMPLETE"
	e:RegisterEvent"GARRISON_MISSION_COMPLETE_RESPONSE"
	e:RegisterEvent"GARRISON_FOLLOWER_XP_CHANGED"
	e:RegisterEvent"GARRISON_FOLLOWER_REMOVED"
	e:RegisterEvent"GARRISON_FOLLOWER_DURABILITY_CHANGED"
	e:RegisterEvent"GARRISON_MISSION_STARTED"
	e:RegisterEvent"GARRISON_UPDATE"
	e:RegisterEvent"GARRISON_MISSION_COMPLETE_RESPONSE"
	e:RegisterEvent"GARRISON_MISSION_FINISHED"
