	...
	local f = CreateFrame('Button', 'dksdRaidStats', CompactRaidFrameManager)
	f:SetHeight(50)
	...
	local t = f:CreateFontString('dksdRaidStats_Alive', 'ARTWORK', 'GameFontHighlight')
	t:SetPoint('TOPLEFT', header, 'BOTTOMLEFT', 0, -6)

	local t2 = f:CreateFontString('dksdRaidStats_Roles', 'ARTWORK', 'GameFontHighlight')
	t2:SetPoint('TOPLEFT', t, 'BOTTOMLEFT', 0, -3)

	local name = f:CreateFontString('dksdRaidStats_GRIDName', 'ARTWORK', 'GameFontHighlight')
