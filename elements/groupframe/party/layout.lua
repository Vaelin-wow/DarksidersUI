	...
	local AddHealth = function(self)
		...
		-- Health:SetPoint('TOPLEFT', self, 5, 0)
	...
	local AddPower = function(self)
		...
		Power:SetPoint('TOP', self.Health, 'BOTTOM',0, -6)
	...
	local AddName = function(self)
		...
		Name:SetPoint('LEFT', self.Health, 2, 22)
	...
	local AddLFDRole = function(self)
		...
		LFDRole:SetPoint('LEFT', self.Health, 2, 22)
		LFDRole:Hide()
		return LFDRole
	end
	...
	local AddPortrait = function(self)
		...
		Portrait:SetPoint('RIGHT', self.Health, 'LEFT', -8, -5)

		Portrait.BG = self.Health:CreateTexture(nil, 'BACKGROUND', nil, 7)
		Portrait.BG:SetSize(205, 101)
		Portrait.BG:SetTexture[[Interface\AddOns\DarksidersUI\art\unitframe\PartyFrame]]
		Portrait.BG:SetPoint('TOPLEFT', Portrait, -18, 19)
		-- Portrait.BG:SetTexCoord(.9175, 1, .075, .16)

		-- Health.back = Health:CreateTexture(nil, 'BORDER')
		-- Health.back:SetTexture[[Interface\AddOns\DarksidersUI\art\unitframe\PartyFrame]]
		-- Health.back:SetPoint('TOPLEFT', Health, 'TOPLEFT', 0, 0)
		-- ns.SB(Health.back)
		-- Health.back:SetVertexColor(.2, .2, .2)
		-- Health.back:SetWidth(211)
		-- Health.back:SetHeight(94)
	...
	ns.UnitSpecific.party = function(self, ...)
		...
		ns.AddAuraElement(self, unit, {'LEFT', self, 'RIGHT', -107, -30}, 'LEFT', 'RIGHT', 'UP', 10)
